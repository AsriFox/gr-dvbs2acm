...
#ifndef INCLUDED_DVBS2ACM_PLSYNC_CC_H
#define INCLUDED_DVBS2ACM_PLSYNC_CC_H
 ...
 */
class DVBS2ACM_API plsync_cc : virtual public gr::block
{
public:
...
#endif /* INCLUDED_DVBS2ACM_PLSYNC_CC_H */
