...
ldpc_std_values ldpc_std_values::std(dvbs2_framesize_t framesize, dvbs2_code_rate_t rate)
{
    if (framesize == FECFRAME_NORMAL) {
        ...
        case C9_10:
            ...
            */
        default:
            return { FRAME_SIZE_NORMAL, FRAME_SIZE_NORMAL, 0, 0, 0, 0, 0, 0, 0, {} };
        }
        ...
        case C8_9:
            ...
            */
        default:
            return { FRAME_SIZE_SHORT, FRAME_SIZE_SHORT, 0, 0, 0, 0, 0, 0, 0, {} };
        }
    }
    /* else {
...
const ldpc_std_values ldpc_std_values::ldpc_tab_1_4N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    16008,
    16200,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_1_3N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    21408,
    21600,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_2_5N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    25728,
    25920,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_1_2N = { FRAME_SIZE_NORMAL,
                                                         FRAME_SIZE_NORMAL,
                                                         32208,
                                                         32400,
                                                         BCH_CODE_M12,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_3_5N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    38688,
    38880,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_2_3N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    43040,
    43200,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_3_4N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    48408,
    48600,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_4_5N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    51648,
    51840,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_5_6N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    53840,
    54000,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_8_9N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    57472,
    57600,
    ...
    0,
    0,
    { { 4, 0, 6235, 2848, 3222 },  { 4, 1, 5800, 3492, 5348 },  { 4, 2, 2757, 927, 90 },     { 4, 3, 6961, 4516, 4739 },
      { 4, 4, 1172, 3237, 6264 },  { 4, 5, 1927, 2425, 3683 },  { 4, 6, 3714, 6309, 2495 },  { 4, 7, 3070, 6342, 7154 },
      { 4, 8, 2428, 613, 3761 },   { 4, 9, 2906, 264, 5927 },   { 4, 10, 1716, 1950, 4273 }, { 4, 11, 4613, 6179, 3491 },
      { 4, 12, 4865, 3286, 6005 }, { 4, 13, 1343, 5923, 3529 }, { 4, 14, 4589, 4035, 2132 }, { 4, 15, 1579, 3920, 6737 },
      { 4, 16, 1644, 1191, 5998 }, { 4, 17, 1482, 2381, 4620 }, { 4, 18, 6791, 6014, 6596 }, { 4, 19, 2738, 5918, 3786 },
      { 3, 0, 5156, 6166, 0 },     { 3, 1, 1504, 4356, 0 },     { 3, 2, 130, 1904, 0 },      { 3, 3, 6027, 3187, 0 },
      { 3, 4, 6718, 759, 0 },      { 3, 5, 6240, 2870, 0 },     { 3, 6, 2343, 1311, 0 },     { 3, 7, 1039, 5465, 0 },
      { 3, 8, 6617, 2513, 0 },     { 3, 9, 1588, 5222, 0 },     { 3, 10, 6561, 535, 0 },     { 3, 11, 4765, 2054, 0 },
      { 3, 12, 5966, 6892, 0 },    { 3, 13, 1969, 3869, 0 },    { 3, 14, 3571, 2420, 0 },    { 3, 15, 4632, 981, 0 },
      { 3, 16, 3215, 4163, 0 },    { 3, 17, 973, 3117, 0 },     { 3, 18, 3802, 6198, 0 },    { 3, 19, 3794, 3948, 0 },
      { 3, 0, 3196, 6126, 0 },     { 3, 1, 573, 1909, 0 },      { 3, 2, 850, 4034, 0 },      { 3, 3, 5622, 1601, 0 },
      { 3, 4, 6005, 524, 0 },      { 3, 5, 5251, 5783, 0 },     { 3, 6, 172, 2032, 0 },      { 3, 7, 1875, 2475, 0 },
      { 3, 8, 497, 1291, 0 },      { 3, 9, 2566, 3430, 0 },     { 3, 10, 1249, 740, 0 },     { 3, 11, 2944, 1948, 0 },
      { 3, 12, 6528, 2899, 0 },    { 3, 13, 2243, 3616, 0 },    { 3, 14, 867, 3733, 0 },     { 3, 15, 1374, 4702, 0 },
      { 3, 16, 4698, 2285, 0 },    { 3, 17, 4760, 3917, 0 },    { 3, 18, 1859, 4058, 0 },    { 3, 19, 6141, 3527, 0 },
      { 3, 0, 2148, 5066, 0 },     { 3, 1, 1306, 145, 0 },      { 3, 2, 2319, 871, 0 },      { 3, 3, 3463, 1061, 0 },
      { 3, 4, 5554, 6647, 0 },     { 3, 5, 5837, 339, 0 },      { 3, 6, 5821, 4932, 0 },     { 3, 7, 6356, 4756, 0 },
      { 3, 8, 3930, 418, 0 },      { 3, 9, 211, 3094, 0 },      { 3, 10, 1007, 4928, 0 },    { 3, 11, 3584, 1235, 0 },
      { 3, 12, 6982, 2869, 0 },    { 3, 13, 1612, 1013, 0 },    { 3, 14, 953, 4964, 0 },     { 3, 15, 4555, 4410, 0 },
      { 3, 16, 4925, 4842, 0 },    { 3, 17, 5778, 600, 0 },     { 3, 18, 6509, 2417, 0 },    { 3, 19, 1260, 4903, 0 },
      { 3, 0, 3369, 3031, 0 },     { 3, 1, 3557, 3224, 0 },     { 3, 2, 3028, 583, 0 },      { 3, 3, 3258, 440, 0 },
      { 3, 4, 6226, 6655, 0 },     { 3, 5, 4895, 1094, 0 },     { 3, 6, 1481, 6847, 0 },     { 3, 7, 4433, 1932, 0 },
      { 3, 8, 2107, 1649, 0 },     { 3, 9, 2119, 2065, 0 },     { 3, 10, 4003, 6388, 0 },    { 3, 11, 6720, 3622, 0 },
      { 3, 12, 3694, 4521, 0 },    { 3, 13, 1164, 7050, 0 },    { 3, 14, 1965, 3613, 0 },    { 3, 15, 4331, 66, 0 },
      { 3, 16, 2970, 1796, 0 },    { 3, 17, 4652, 3218, 0 },    { 3, 18, 1762, 4777, 0 },    { 3, 19, 5736, 1399, 0 },
      { 3, 0, 970, 2572, 0 },      { 3, 1, 2062, 6599, 0 },     { 3, 2, 4597, 4870, 0 },     { 3, 3, 1228, 6913, 0 },
      { 3, 4, 4159, 1037, 0 },     { 3, 5, 2916, 2362, 0 },     { 3, 6, 395, 1226, 0 },      { 3, 7, 6911, 4548, 0 },
      { 3, 8, 4618, 2241, 0 },     { 3, 9, 4120, 4280, 0 },     { 3, 10, 5825, 474, 0 },     { 3, 11, 2154, 5558, 0 },
      { 3, 12, 3793, 5471, 0 },    { 3, 13, 5707, 1595, 0 },    { 3, 14, 1403, 325, 0 },     { 3, 15, 6601, 5183, 0 },
      { 3, 16, 6369, 4569, 0 },    { 3, 17, 4846, 896, 0 },     { 3, 18, 7092, 6184, 0 },    { 3, 19, 6764, 7127, 0 },
      { 3, 0, 6358, 1951, 0 },     { 3, 1, 3117, 6960, 0 },     { 3, 2, 2710, 7062, 0 },     { 3, 3, 1133, 3604, 0 },
      { 3, 4, 3694, 657, 0 },      { 3, 5, 1355, 110, 0 },      { 3, 6, 3329, 6736, 0 },     { 3, 7, 2505, 3407, 0 },
      { 3, 8, 2462, 4806, 0 },     { 3, 9, 4216, 214, 0 },      { 3, 10, 5348, 5619, 0 },    { 3, 11, 6627, 6243, 0 },
      { 3, 12, 2644, 5073, 0 },    { 3, 13, 4212, 5088, 0 },    { 3, 14, 3463, 3889, 0 },    { 3, 15, 5306, 478, 0 },
      { 3, 16, 4320, 6121, 0 },    { 3, 17, 3961, 1125, 0 },    { 3, 18, 5699, 1195, 0 },    { 3, 19, 6511, 792, 0 },
      { 3, 0, 3934, 2778, 0 },     { 3, 1, 3238, 6587, 0 },     { 3, 2, 1111, 6596, 0 },     { 3, 3, 1457, 6226, 0 },
      { 3, 4, 1446, 3885, 0 },     { 3, 5, 3907, 4043, 0 },     { 3, 6, 6839, 2873, 0 },     { 3, 7, 1733, 5615, 0 },
      { 3, 8, 5202, 4269, 0 },     { 3, 9, 3024, 4722, 0 },     { 3, 10, 5445, 6372, 0 },    { 3, 11, 370, 1828, 0 },
      { 3, 12, 4695, 1600, 0 },    { 3, 13, 680, 2074, 0 },     { 3, 14, 1801, 6690, 0 },    { 3, 15, 2669, 1377, 0 },
      { 3, 16, 2463, 1681, 0 },    { 3, 17, 5972, 5171, 0 },    { 3, 18, 5728, 4284, 0 },    { 3, 19, 1696, 1459, 0 } }
};

const ldpc_std_values ldpc_std_values::ldpc_tab_9_10N = {
    FRAME_SIZE_NORMAL,
    FRAME_SIZE_NORMAL,
    58192,
    58320,
    ...
    0,
    0,
    { { 4, 0, 5611, 2563, 2900 },  { 4, 1, 5220, 3143, 4813 },  { 4, 2, 2481, 834, 81 },     { 4, 3, 6265, 4064, 4265 },
      { 4, 4, 1055, 2914, 5638 },  { 4, 5, 1734, 2182, 3315 },  { 4, 6, 3342, 5678, 2246 },  { 4, 7, 2185, 552, 3385 },
      { 4, 8, 2615, 236, 5334 },   { 4, 9, 1546, 1755, 3846 },  { 4, 10, 4154, 5561, 3142 }, { 4, 11, 4382, 2957, 5400 },
      { 4, 12, 1209, 5329, 3179 }, { 4, 13, 1421, 3528, 6063 }, { 4, 14, 1480, 1072, 5398 }, { 4, 15, 3843, 1777, 4369 },
      { 4, 16, 1334, 2145, 4163 }, { 4, 17, 2368, 5055, 260 },  { 3, 0, 6118, 5405, 0 },     { 3, 1, 2994, 4370, 0 },
      { 3, 2, 3405, 1669, 0 },     { 3, 3, 4640, 5550, 0 },     { 3, 4, 1354, 3921, 0 },     { 3, 5, 117, 1713, 0 },
      { 3, 6, 5425, 2866, 0 },     { 3, 7, 6047, 683, 0 },      { 3, 8, 5616, 2582, 0 },     { 3, 9, 2108, 1179, 0 },
      { 3, 10, 933, 4921, 0 },     { 3, 11, 5953, 2261, 0 },    { 3, 12, 1430, 4699, 0 },    { 3, 13, 5905, 480, 0 },
      { 3, 14, 4289, 1846, 0 },    { 3, 15, 5374, 6208, 0 },    { 3, 16, 1775, 3476, 0 },    { 3, 17, 3216, 2178, 0 },
      { 3, 0, 4165, 884, 0 },      { 3, 1, 2896, 3744, 0 },     { 3, 2, 874, 2801, 0 },      { 3, 3, 3423, 5579, 0 },
      { 3, 4, 3404, 3552, 0 },     { 3, 5, 2876, 5515, 0 },     { 3, 6, 516, 1719, 0 },      { 3, 7, 765, 3631, 0 },
      { 3, 8, 5059, 1441, 0 },     { 3, 9, 5629, 598, 0 },      { 3, 10, 5405, 473, 0 },     { 3, 11, 4724, 5210, 0 },
      { 3, 12, 155, 1832, 0 },     { 3, 13, 1689, 2229, 0 },    { 3, 14, 449, 1164, 0 },     { 3, 15, 2308, 3088, 0 },
      { 3, 16, 1122, 669, 0 },     { 3, 17, 2268, 5758, 0 },    { 3, 0, 5878, 2609, 0 },     { 3, 1, 782, 3359, 0 },
      { 3, 2, 1231, 4231, 0 },     { 3, 3, 4225, 2052, 0 },     { 3, 4, 4286, 3517, 0 },     { 3, 5, 5531, 3184, 0 },
      { 3, 6, 1935, 4560, 0 },     { 3, 7, 1174, 131, 0 },      { 3, 8, 3115, 956, 0 },      { 3, 9, 3129, 1088, 0 },
      { 3, 10, 5238, 4440, 0 },    { 3, 11, 5722, 4280, 0 },    { 3, 12, 3540, 375, 0 },     { 3, 13, 191, 2782, 0 },
      { 3, 14, 906, 4432, 0 },     { 3, 15, 3225, 1111, 0 },    { 3, 16, 6296, 2583, 0 },    { 3, 17, 1457, 903, 0 },
      { 3, 0, 855, 4475, 0 },      { 3, 1, 4097, 3970, 0 },     { 3, 2, 4433, 4361, 0 },     { 3, 3, 5198, 541, 0 },
      { 3, 4, 1146, 4426, 0 },     { 3, 5, 3202, 2902, 0 },     { 3, 6, 2724, 525, 0 },      { 3, 7, 1083, 4124, 0 },
      { 3, 8, 2326, 6003, 0 },     { 3, 9, 5605, 5990, 0 },     { 3, 10, 4376, 1579, 0 },    { 3, 11, 4407, 984, 0 },
      { 3, 12, 1332, 6163, 0 },    { 3, 13, 5359, 3975, 0 },    { 3, 14, 1907, 1854, 0 },    { 3, 15, 3601, 5748, 0 },
      { 3, 16, 6056, 3266, 0 },    { 3, 17, 3322, 4085, 0 },    { 3, 0, 1768, 3244, 0 },     { 3, 1, 2149, 144, 0 },
      { 3, 2, 1589, 4291, 0 },     { 3, 3, 5154, 1252, 0 },     { 3, 4, 1855, 5939, 0 },     { 3, 5, 4820, 2706, 0 },
      { 3, 6, 1475, 3360, 0 },     { 3, 7, 4266, 693, 0 },      { 3, 8, 4156, 2018, 0 },     { 3, 9, 2103, 752, 0 },
      { 3, 10, 3710, 3853, 0 },    { 3, 11, 5123, 931, 0 },     { 3, 12, 6146, 3323, 0 },    { 3, 13, 1939, 5002, 0 },
      { 3, 14, 5140, 1437, 0 },    { 3, 15, 1263, 293, 0 },     { 3, 16, 5949, 4665, 0 },    { 3, 17, 4548, 6380, 0 },
      { 3, 0, 3171, 4690, 0 },     { 3, 1, 5204, 2114, 0 },     { 3, 2, 6384, 5565, 0 },     { 3, 3, 5722, 1757, 0 },
      { 3, 4, 2805, 6264, 0 },     { 3, 5, 1202, 2616, 0 },     { 3, 6, 1018, 3244, 0 },     { 3, 7, 4018, 5289, 0 },
      { 3, 8, 2257, 3067, 0 },     { 3, 9, 2483, 3073, 0 },     { 3, 10, 1196, 5329, 0 },    { 3, 11, 649, 3918, 0 },
      { 3, 12, 3791, 4581, 0 },    { 3, 13, 5028, 3803, 0 },    { 3, 14, 3119, 3506, 0 },    { 3, 15, 4779, 431, 0 },
      { 3, 16, 3888, 5510, 0 },    { 3, 17, 4387, 4084, 0 },    { 3, 0, 5836, 1692, 0 },     { 3, 1, 5126, 1078, 0 },
      { 3, 2, 5721, 6165, 0 },     { 3, 3, 3540, 2499, 0 },     { 3, 4, 2225, 6348, 0 },     { 3, 5, 1044, 1484, 0 },
      { 3, 6, 6323, 4042, 0 },     { 3, 7, 1313, 5603, 0 },     { 3, 8, 1303, 3496, 0 },     { 3, 9, 3516, 3639, 0 },
      { 3, 10, 5161, 2293, 0 },    { 3, 11, 4682, 3845, 0 },    { 3, 12, 3045, 643, 0 },     { 3, 13, 2818, 2616, 0 },
      { 3, 14, 3267, 649, 0 },     { 3, 15, 6236, 593, 0 },     { 3, 16, 646, 2948, 0 },     { 3, 17, 4213, 1442, 0 },
      { 3, 0, 5779, 1596, 0 },     { 3, 1, 2403, 1237, 0 },     { 3, 2, 2217, 1514, 0 },     { 3, 3, 5609, 716, 0 },
      { 3, 4, 5155, 3858, 0 },     { 3, 5, 1517, 1312, 0 },     { 3, 6, 2554, 3158, 0 },     { 3, 7, 5280, 2643, 0 },
      { 3, 8, 4990, 1353, 0 },     { 3, 9, 5648, 1170, 0 },     { 3, 10, 1152, 4366, 0 },    { 3, 11, 3561, 5368, 0 },
      { 3, 12, 3581, 1411, 0 },    { 3, 13, 5647, 4661, 0 },    { 3, 14, 1542, 5401, 0 },    { 3, 15, 5078, 2687, 0 },
      { 3, 16, 316, 1755, 0 },     { 3, 17, 3392, 1991, 0 } }
};

const ldpc_std_values ldpc_std_values::ldpc_tab_1_4S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    3072,
    3240,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_1_3S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    5232,
    5400,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_2_5S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    6312,
    6480,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_1_2S = { FRAME_SIZE_SHORT,
                                                         FRAME_SIZE_SHORT,
                                                         7032,
                                                         7200,
                                                         BCH_CODE_S12,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_3_5S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    9552,
    9720,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_2_3S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    10632,
    10800,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_3_4S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    11712,
    11880,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_4_5S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    12432,
    12600,
    ...
    0,
    0,
    { { 3, 5, 896, 1565 },  { 3, 6, 2493, 184 },  { 3, 7, 212, 3210 },  { 3, 8, 727, 1339 },  { 3, 9, 3428, 612 },
      { 3, 0, 2663, 1947 }, { 3, 1, 230, 2695 },  { 3, 2, 2025, 2794 }, { 3, 3, 3039, 283 },  { 3, 4, 862, 2889 },
      { 3, 5, 376, 2110 },  { 3, 6, 2034, 2286 }, { 3, 7, 951, 2068 },  { 3, 8, 3108, 3542 }, { 3, 9, 307, 1421 },
      { 3, 0, 2272, 1197 }, { 3, 1, 1800, 3280 }, { 3, 2, 331, 2308 },  { 3, 3, 465, 2552 },  { 3, 4, 1038, 2479 },
      { 3, 5, 1383, 343 },  { 3, 6, 94, 236 },    { 3, 7, 2619, 121 },  { 3, 8, 1497, 2774 }, { 3, 9, 2116, 1855 },
      { 3, 0, 722, 1584 },  { 3, 1, 2767, 1881 }, { 3, 2, 2701, 1610 }, { 3, 3, 3283, 1732 }, { 3, 4, 168, 1099 },
      { 3, 5, 3074, 243 },  { 3, 6, 3460, 945 },  { 3, 7, 2049, 1746 }, { 3, 8, 566, 1427 },  { 3, 9, 3545, 1168 } }
};

const ldpc_std_values ldpc_std_values::ldpc_tab_5_6S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    13152,
    13320,
...
const ldpc_std_values ldpc_std_values::ldpc_tab_8_9S = {
    FRAME_SIZE_SHORT,
    FRAME_SIZE_SHORT,
    14232,
    14400,
    ...
    { { 4, 0, 1558, 712, 805 }, { 4, 1, 1450, 873, 1337 }, { 4, 2, 1741, 1129, 1184 }, { 4, 3, 294, 806, 1566 },
      { 4, 4, 482, 605, 923 },  { 3, 0, 926, 1578, 0 },    { 3, 1, 777, 1374, 0 },     { 3, 2, 608, 151, 0 },
      { 3, 3, 1195, 210, 0 },   { 3, 4, 1484, 692, 0 },    { 3, 0, 427, 488, 0 },      { 3, 1, 828, 1124, 0 },
      { 3, 2, 874, 1366, 0 },   { 3, 3, 1500, 835, 0 },    { 3, 4, 1496, 502, 0 },     { 3, 0, 1006, 1701, 0 },
      { 3, 1, 1155, 97, 0 },    { 3, 2, 657, 1403, 0 },    { 3, 3, 1453, 624, 0 },     { 3, 4, 429, 1495, 0 },
      { 3, 0, 809, 385, 0 },    { 3, 1, 367, 151, 0 },     { 3, 2, 1323, 202, 0 },     { 3, 3, 960, 318, 0 },
      { 3, 4, 1451, 1039, 0 },  { 3, 0, 1098, 1722, 0 },   { 3, 1, 1015, 1428, 0 },    { 3, 2, 1261, 1564, 0 },
      { 3, 3, 544, 1190, 0 },   { 3, 4, 1472, 1246, 0 },   { 3, 0, 508, 630, 0 },      { 3, 1, 421, 1704, 0 },
      { 3, 2, 284, 898, 0 },    { 3, 3, 392, 577, 0 },     { 3, 4, 1155, 556, 0 },     { 3, 0, 631, 1000, 0 },
      { 3, 1, 732, 1368, 0 },   { 3, 2, 1328, 329, 0 },    { 3, 3, 1515, 506, 0 },     { 3, 4, 1104, 1172, 0 } }
};
